...
typealias HeaderPredicateBlock = (itemPosition: Int) -> Boolean
class HeaderItemDecoration(parent: RecyclerView, private val headerPredicateBlock: HeaderPredicateBlock): RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (headerPredicateBlock(parent.getChildAdapterPosition(childInContact))) {
    ...
    private fun getHeaderPositionForItem(itemPosition: Int): Int {
        ...
        do {
            if (headerPredicateBlock(currentPosition)) {
