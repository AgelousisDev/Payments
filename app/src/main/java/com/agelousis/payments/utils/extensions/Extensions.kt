...
fun Date.toCalendar(plusMonths: Int? = null): Calendar {
    ...
    //calendar.set(Calendar.MONTH, if (calendar.get(Calendar.MONTH) == 11 && plusMonths != null) 0 + plusMonths else calendar.get(Calendar.MONTH) + (plusMonths ?: 0))
    return calendar
}
